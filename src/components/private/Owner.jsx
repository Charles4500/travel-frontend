          ...
          <div class="w-full md:w-1/2 p-5">
            <div class="p-12 lg:p-16 border border-gray-900 rounded-5xl">
              ...
              <p class="mb-24 lg:mb-56 text-lg text-white text-opacity-60">
                For most currencies, there are no limits to the transfer amount.
                Certain currencies might have limits set by our payments
                partners. You will always see the limit in the Revolut app
